...
local globalkeys = gears.table.join(
	...
	awful.key({ modkey }, "period", function () quake:toggle() end, { description = "show help", group = "awesome" }),
...
local clientkeys = gears.table.join(
	...
	awful.key({ modkey }, "Return", function(c)
		...
		if c == mc then
			c = awful.client.focus.history.list[2] or c
			client.focus = c
		end
		c:swap(mc)
	end, { description = "swap to/from master", group = "client" }),
	awful.key({ modkey }, "Tab", function(c)
		local lc = awful.client.focus.history.list[2] or c
		client.focus = lc
		lc:raise()
	end, { description = "swap the last client with master", group = "client" }),
